...
def joinTeam3(request):
    cd = request.session['cd']
    teamMember = Person(StudentID=cd['schoolId'], FirstName=cd['FirstName'], LastName=cd['LastName'], ShirtSize=cd['shirtSize'], PhoneNumber=cd['phoneNumber'], Email=cd['Email'], Gender=cd['gender'])
    teamMember.save()
    team = request.session['team']
