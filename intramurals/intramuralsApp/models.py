...
class Person(models.Model):
        FLOORS = (('Off Campus','Off Campus'),
		  ('Foundation','Foundation'),
		  ('Sammy II','Sammy II'),
		  ('Broho','Broho'),
		  ('Penthouse','Penthouse'),
		  ('First East Wengatz','First East Wengatz'),
		  ('First West Wengatz','First West Wengatz'),
		  ('Second East Wengatz','Second East Wengatz'),
		  ('Second West Wengatz','Second West Wengatz'),
		  ('Second Center Wengatz','Second Center Wengatz'),
		  ...
		  ('Second Center Olson','Second Center Olson'),
		  ('Third East Olson','Third East Olson'),
		  ('Third West Olson','Third West Olson'),
		  ('Third Center Olson','Third Center Olson'),
		  ('First South English','First South English'),
		  ('First North English','First North English'),
		  ('Second South English','Second South English'),
		  ('Second Center English','Second Center English'),
		  ('Second North English','Second North English'),
		  ('Third South English','Third South English'),
		  ('Third Center English','Third Center English'),
		  ('Third North English','Third North English'),
		  ('First Floor Gerig','First Floor Gerig'),
		  ('Second Floor Gerig','Second Floor Gerig'),
		  ('Third Floor Gerig','Third Floor Gerig'),
		  ('First Berg','First Berg'),
		  ('Second Berg','Second Berg'),
		  ('Third Berg','Third Berg'),
		  ('Fourth Berg','Fourth Berg'),
		  ('First Swallow','First Swallow'),
		  ('Second Swallow','Second Swallow'),
		  ('Third Swallow','Third Swallow'))
	SHIRTSIZE = (
		('XS', 'XS'),
		('S', 'S'),
		('M', 'M'),
